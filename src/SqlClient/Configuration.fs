...
type FsharpDataSqlClientConfiguration = { ResultsetRuntimeVerification: bool }
...
module Configuration =
    ...
    let mutable internal current =
        { FsharpDataSqlClientConfiguration.ResultsetRuntimeVerification = false }
